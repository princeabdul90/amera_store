import 'seller_sign_in_localizations.dart';

/// The translations for English (`en`).
class SellerSignInLocalizationsEn extends SellerSignInLocalizations {
  SellerSignInLocalizationsEn([String locale = 'en']) : super(locale);
