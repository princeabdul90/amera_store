...
abstract class SignUpLocalizations {
  ...
  /// No description provided for @fullnameTextFieldLabel.
  ///
  /// In en, this message translates to:
  /// **'Fullname'**
  String get fullnameTextFieldLabel;

  /// No description provided for @fullnameTextFieldEmptyErrorMessage.
  ///
  /// In en, this message translates to:
  /// **'Your full name can\'t be empty.'**
  String get fullnameTextFieldEmptyErrorMessage;

  /// No description provided for @fullnameTextFieldInvalidErrorMessage.
  ///
  /// In en, this message translates to:
  /// **'Your fullname must be 1-20 characters long and can only contain letters, numbers, and the underscore (_).'**
  String get fullnameTextFieldInvalidErrorMessage;

  /// No description provided for @fullnameTextFieldAlreadyTakenErrorMessage.
  ///
  /// In en, this message translates to:
  /// **'This fullname is already taken.'**
  String get fullnameTextFieldAlreadyTakenErrorMessage;
