...
class HomeAndGarden extends StatelessWidget {
  const HomeAndGarden({Key? key, required this.onTapCategoryItem}) : super(key: key);
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          HeaderTitle(name: l10.homeAndGardenCategoryLabel.toUpperCase(),),
              ...
              child: GridView.count(
                ...
                children: List.generate(homeandgarden.length -1, (index) {
                  ...
                  return GestureDetector(
                    ...
                    child: CategoryCard(imagePath: "assets/images/homegarden/home$index.jpg", title: homeandgarden[index +1],)
