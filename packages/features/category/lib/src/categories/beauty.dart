...
class Beauty extends StatelessWidget {
  const Beauty({Key? key, required this.onTapCategoryItem}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Column(
        children: [
          HeaderTitle(
            name: l10.beautyCategoryLabel.toUpperCase(),
          ),
          Padding(
              ...
              child: GridView.count(
                ...
                children: List.generate(beauty.length - 1, (index) {
                  return GestureDetector(
                      ...
                      child: CategoryCard(
                        imagePath: "assets/images/beauty/beauty$index.jpg",
                        title: beauty[index + 1],
                      ));
                }),
              ),
            ),
